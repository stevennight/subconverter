        ...
        case "snell"_hash:
            ...
            for(i = 3; i < configs.size(); i++)
            {
                ...
                case "obfs-uri"_hash:
                    ...
                    break;
                case "reuse"_hash:
                    section = itemVal; // temporarily using 'section' var for reuse
                    break;
                case "udp-relay"_hash:
                    udp = itemVal;
                    break;
            ...
            snellConstruct(node, SNELL_DEFAULT_GROUP, remarks, server, port, password, plugin, host, to_int(version, 0), tribool(section), path, udp, tfo, scv);
            break;
        case "wireguard"_hash:
